...
extern int    DoGlobalDefine(UBYTE *);
extern int    TheDefine(UBYTE *,int,int);
...
extern int    DoSum(UBYTE *);
extern int    DoProd(UBYTE *);
extern int    DoBreakDo(UBYTE *);
extern int    DoEnddo(UBYTE *);
extern int    DoEndsum(UBYTE *);
extern int    DoEndprod(UBYTE *);
